...
('REANALYSIS_P1', 'Programa Reanálise 1'),
('REANALYSIS_P2', 'Programa Reanálise 2'),
('REANALYSIS_P3', 'Programa Reanálise 3'),
('REANALYSIS_P4', 'Programa Reanálise 4'),
('REANALYSIS_P5', 'Programa Reanálise 5');
...
values ('REANALYSIS-V1', '04.99.909', '2031-01', 'REANALYSIS_P1', '{}', '{"ata":"Não analisado"}');
insert into public.pendencies (id, school_id, competence_origin, program_id, document_key, status, payload)
values ('REANALYSIS-P1', '04.99.909', '2031-01', 'REANALYSIS_P1', 'ata', 'Aguardando reanálise', '{}');
select throws_ok($$
...
insert into public.verifications (id, school_id, competence_id, program_id, bonification, analysis)
values ('REANALYSIS-V2', '04.99.909', '2031-01', 'REANALYSIS_P2', '{}', '{"ata":"Não analisado"}');
insert into public.pendencies (id, school_id, competence_origin, program_id, document_key, status, payload)
values ('REANALYSIS-P2', '04.99.909', '2031-01', 'REANALYSIS_P2', 'ata', 'Aguardando reanálise', '{}');
...
('REANALYSIS-V3', '04.99.909', '2031-01', 'REANALYSIS_P3', '{}', '{"ata":"Não analisado"}'),
('REANALYSIS-V3-WRONG', '04.99.909', '2031-02', 'REANALYSIS_P3', '{}', '{"ata":"Não analisado"}');
insert into public.pendencies (id, school_id, competence_origin, program_id, document_key, status, payload)
values ('REANALYSIS-P3', '04.99.909', '2031-01', 'REANALYSIS_P3', 'ata', 'Aguardando reanálise', '{}');
...
insert into public.verifications (id, school_id, competence_id, program_id, bonification, analysis)
values ('REANALYSIS-V4', '04.99.909', '2031-01', 'REANALYSIS_P4', '{}', '{"ata":"Não analisado"}');
insert into public.pendencies (id, school_id, competence_origin, program_id, document_key, status, payload)
values ('REANALYSIS-P4', '04.99.909', '2031-01', 'REANALYSIS_P4', 'ata', 'Aguardando reanálise', '{}');
insert into public.pendency_attempts (id, pendency_id, attempt_number, submitted_at, observation, drive_url, errors, payload)
values ('REANALYSIS-A4', 'REANALYSIS-P4', 1, '2031-01-13T12:00:00Z', 'Original da escola', 'https://drive.example/original', '[]', '{"origem":"escola"}');
select lives_ok($$
    select public.reanalyze_pendency_with_verification(
        '{"id":"REANALYSIS-P4","status":"Resolvida","notes":"Regularizada","payload":{}}'::jsonb,
...
$$, 'reanálise válida conclui com a tentativa aguardando real mesmo quando o caller especializado omite resolved_at');
select ok(
    (select status = 'Resolvida' and resolved_at is not null from public.pendencies where id = 'REANALYSIS-P4')
    ...
    'reanálise válida preserva o envio da escola, materializa resolução e atualiza somente análise e estado'
);

insert into public.verifications (id, school_id, competence_id, program_id, bonification, analysis)
values ('REANALYSIS-V5', '04.99.909', '2031-01', 'REANALYSIS_P5', '{}', '{"ata":"Não analisado"}');
insert into public.pendencies (id, school_id, competence_origin, program_id, document_key, status, payload)
values ('REANALYSIS-P5', '04.99.909', '2031-01', 'REANALYSIS_P5', 'ata', 'Aguardando reanálise', '{}');
insert into public.pendency_attempts (id, pendency_id, attempt_number, submitted_at, observation, drive_url, errors, payload)
