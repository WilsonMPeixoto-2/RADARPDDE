...
values
    ('81111111-1111-4111-8111-111111111111', '11111111-1111-4111-8111-111111111111', 'controller@radar.local', '{"sub":"11111111-1111-4111-8111-111111111111","email":"controller@radar.local"}', 'email', now(), now(), now()),
    ('82222222-2222-4222-8222-222222222222', '22222222-2222-4222-8222-222222222222', 'assistant@radar.local', '{"sub":"22222222-2222-4222-8222-222222222222","email":"assistant@radar.local"}', 'email', now(), now(), now()),
    ('83333333-3333-4333-8333-333333333333', '33333333-3333-4333-8333-333333333333', 'inventory@radar.local', '{"sub":"33333333-3333-4333-8333-333333333333","email":"inventory@radar.local"}', 'email', now(), now(), now()),
    ('84444444-4444-4444-8444-444444444444', '44444444-4444-4444-8444-444444444444', 'sme@radar.local', '{"sub":"44444444-4444-4444-8444-444444444444","email":"sme@radar.local"}', 'email', now(), now(), now()),
    ('85555555-5555-4555-8555-555555555555', '55555555-5555-4555-8555-555555555555', 'admin@radar.local', '{"sub":"55555555-5555-4555-8555-555555555555","email":"admin@radar.local"}', 'email', now(), now(), now()),
    ('86666666-6666-4666-8666-666666666666', '66666666-6666-4666-8666-666666666666', 'inactive@radar.local', '{"sub":"66666666-6666-4666-8666-666666666666","email":"inactive@radar.local"}', 'email', now(), now(), now()),
    ('87777777-7777-4777-8777-777777777777', '77777777-7777-4777-8777-777777777777', 'without-profile@radar.local', '{"sub":"77777777-7777-4777-8777-777777777777","email":"without-profile@radar.local"}', 'email', now(), now(), now())
