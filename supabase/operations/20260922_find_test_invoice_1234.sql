-- Dry-run transacional da limpeza do lançamento de teste. Nada persiste: ROLLBACK obrigatório.
begin;
...
begin
  ...
  raise notice 'DRY_RUN_OK: invoice %, pendency %, verification row_version % -> %',
    v_invoice.id, v_pendency.id, v_verification.row_version, v_after.row_version;
end
$$;
