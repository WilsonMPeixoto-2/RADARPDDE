-- RADAR PDDE — distingue ausência de bonus_result de limpeza explícita na RPC de NF.
-- Campo ausente preserva a consolidação; campo presente com string vazia reabre a avaliação.
