-- RADAR PDDE — abertura documental + análise técnica incorreta em uma única transação.
-- Evita o estado inválido "Incorreto sem pendência" quando o usuário abandona o modal.
...
begin
    ...
    -- Abertura manual continua podendo ocorrer sem tocar a verificação. Quando
    -- a abertura nasce de "Análise = Incorreto", a verificação e sua versão
    -- são obrigatórias e devem pertencer ao mesmo contexto documental.
