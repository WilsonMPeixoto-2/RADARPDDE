...
- Supabase CLI permanece em `2.114.0`: a tentativa com `2.116.0` falhou em duas garantias pgTAP/RLS de `service_role`; atualização rejeitada até nova versão ou correção comprovada.
...
- Supabase CLI `2.116.0`: rejeitado pelo resultado pgTAP/RLS observado.
