...
- Último bloco concluído: 5 — Notas, documentos e Inventário.
...
- Investigação seguinte: ciclo completo do histórico administrativo.
- Pendentes: blocos 6–12; situação efetiva de Production não revalidada; nenhuma medição atual do banco; nenhuma prova de equivalência integral.
