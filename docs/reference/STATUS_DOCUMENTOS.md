...
|---|---|
| afirmação de que o Excel SME estava integralmente funcional em Production | o conteúdo foi homologado, mas o deployment vigente omitiu o template e retorna HTTP 404; prevalecem o incidente e o hotfix do PR `#133` |
