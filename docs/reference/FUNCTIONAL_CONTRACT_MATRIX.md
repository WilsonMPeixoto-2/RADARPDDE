...
- **PEND-01 — Abrir pendência documental/manual ou pendência fiscal individual vinculada:** A identidade fiscal individual e a abertura atômica estão cobertas por testes locais/SQL; falta prova autenticada no Preview/ambiente publicado com duas invoices distintas e releitura.
- **PEND-02 — Registrar novo envio para regularização:** O novo envio fiscal individual preserva a bonificação e recoloca apenas a invoice vinculada em Não analisado; falta prova autenticada publicada do ciclo completo e releitura.
- **PEND-03 — Reanalisar tentativa e resolver ou reabrir pendência:** A reanálise fiscal individual altera somente a invoice vinculada e o resumo derivado; falta prova autenticada publicada dos resultados correto/incorreto, conflito e releitura.
...
- **INV-01 — Cadastrar/editar Nota Fiscal ou despesa, incluindo criação atômica de A identificar:** Cadastro/edição e a_identificar = Incorreto + Pendência estão cobertos localmente; falta prova autenticada publicada para criação atômica, transformação preservando ID, efeitos patrimoniais e releitura.
...
- **INV-03 — Registrar envio, análise, pendência, novo envio e reanálise da Assessoria por nota fiscal de serviço:** O vínculo individual por NF, as operações compostas e a preservação histórica estão cobertos localmente; falta prova controlada no ambiente publicado com duas NFs de serviço, persistência individual, resumo derivado e releitura.
- **INV-04 — Analisar cada documento fiscal, abrir Pendência por invoice e manter resumo técnico derivado:** Domínio, unit, pgTAP e E2E foram ampliados no PR #211; resta Preview desktop autenticado, releitura remota e validação final antes de Production.
