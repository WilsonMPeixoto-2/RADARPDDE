...
- **PEND-02 — Registrar novo envio para regularização, incluindo identificação de a_identificar:** Novo envio fiscal individual, identificação preservando ID e criação patrimonial na mesma operação estão cobertos em unitários/pgTAP/E2E descartável; falta prova autenticada publicada do ciclo completo e releitura.
...
- **INV-03 — Registrar envio, análise, pendência, novo envio e reanálise da Assessoria por nota fiscal de serviço:** Vínculo individual por NF, ausência de bloqueio cruzado, abertura atômica de Incorreto + Pendência, duas Pendências simultâneas e resumo mensal derivado estão comprovados em unitários/E2E/pgTAP; falta somente a conferência visual autenticada do Preview final e o smoke pós-publicação.
- **INV-04 — Analisar cada documento fiscal, abrir Pendência por invoice e manter resumo técnico derivado:** Análise individual, resumo derivado, Pendência por invoice, bloqueio de edição com Pendência ativa e reanálise vinculada estão cobertos em unitários, pgTAP e E2E descartável; falta Preview desktop autenticado e smoke pós-publicação.
