...
| `PEND-02` | Registrar novo envio para regularização | write / P0 | Controlador, Assistente de Verbas Federais, Administrador técnico | PendencyService.registerAttempt + registerInvoiceDocumentAttempt → savePendencyCommand + register_invoice_document_attempt + pendencies_sync_attempt_statuses (registered_invoices, pendencies, pendency_attempts, verifications, administrative_logs) | Parcial | Escrita controlada e reversível |
