...
| BL-UX-01 | P1 | B3 | modais/feedback | IC/FA | 17 `alert/confirm`; modais novos testados | contratos acessíveis e diálogos nativos coexistem | feedback previsível e não bloqueante; confirmações críticas acessíveis | texto, regras e bloqueios | contratos C-01–C-16 | sim | sim para ações críticas | neutro | Interações compartilhadas |
