...
test('ferramentas Supabase modernas estão fixadas e reproduzíveis', () => {
    ...
    assert.equal(pkg.devDependencies['@supabase/supabase-js'], '2.115.0');
