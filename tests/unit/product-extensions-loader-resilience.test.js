        ...
        head: {
            appendChild(node) {
                ...
                queueMicrotask(() => {
                    ...
                    if (node.src.endsWith('/evaluation-retification.js')) root.RadarEvaluationRetification = { install: () => true };
                    if (node.src.endsWith('/evaluation-retification-ui.js')) root.RadarEvaluationRetificationUi = { install: () => true };
                    node.dispatch('load');
                });
                return node;
            }
